...
print(os.path.exists("/Users/aviluvchik/z_CLEARAPP/BankLeumi/bank_leumi_tool/assets/client_logo.png"))

# --- Paths for logos ---
script_dir = os.path.dirname(__file__)  # Directory of the script
oporto_logo_path = os.path.join(script_dir, "assets/oporto_logo.png")
leumi_logo_path = os.path.join(script_dir, "assets/client_logo.png")
...
# ================= 3) COMPLIANCE & REGULATORY =================
    ...
    kpi_melted = kpi_data.melt(id_vars=["KPI"], var_name="Year", value_name="Value")
